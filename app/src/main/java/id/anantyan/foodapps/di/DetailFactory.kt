...
import id.anantyan.foodapps.presentation.detail.DetailViewModel
import id.anantyan.foodapps.presentation.home.HomeViewModel

class DetailFactory(private val foodsUseCase: FoodsUseCase) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DetailViewModel::class.java)) {
            return DetailViewModel(foodsUseCase) as T
        }
